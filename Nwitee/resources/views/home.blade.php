        ...
        <div class="main">
            ...
            <div class="post">
                ...
                <small class="float-right">
                    <span title="Likes" id="saveLikeDislike" data-type="like" data-post="{{ $post->id }}" class="mr-2 btn btn-sm btn-outline-primary d-inline font-wight-bold">
                        Like
                        <span class="like-count">{{ $post->likes() }}</span>
                    </span>
                    <span title="Dislikes" id="saveLikeDislike" data-type="dislike" data-post="{{ $post->id }}" class="mr-2 btn btn-sm btn-outline-danger d-inline font-wight-bold">
                        Dislike
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="comment">
                            <div class="author-info">
                                {{-- <img src="/img/avatars/{{ old('avatar', Auth::user()->avatar) }}" style="width:50px; height:50px; border-radius:50%; display: block;"> --}}
                            ...
                            <div class="comment-content">
                                ...
                                <div class="dropdown1">
                                    ...
                                    <div class="dropdown-content1">
                                        <a href="comment/{{ $post->id}}"><i class="fas fa-edit"></i>Edit</a>
                                        <a href="delete/{{ $comment->id }}"><i class="fas fa-trash"></i>Delete</a>
                                    </div>
                                </div>
                            </div>
