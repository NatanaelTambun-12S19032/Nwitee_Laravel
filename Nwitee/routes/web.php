...
Route::put('/updateForum/{id}', 'App\Http\Controllers\forumController@update');
...
// Route::get('/delete/{id}', 'App\Http\Controllers\CommentsController@destroy');

//like or dislike
Route::post('save-likedislike', 'App\Http\Controllers\PostController@save_likedislike')->name('like.dislike');

Route::get('post', 'PostForumController@create')->name('post.create');
Route::post('post', 'PostForumController@store')->name('post.store');
Route::get('/posts', 'PostForumController@index')->name('posts');
Route::get('/article/{post:slug}', 'PostForumController@show')->name('post.show');
Route::post('/comment/store', 'CommentForumController@store')->name('comment.add');
Route::post('/reply/store', 'CommenForumtController@replyStore')->name('reply.add');